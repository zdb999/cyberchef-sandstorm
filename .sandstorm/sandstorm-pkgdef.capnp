...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "0v5zvq5faz979cq7mj27pete5s6du0ph780dh75eaax08v6vumr0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Cyber Chef"),
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "data analyzer"),
        command = .myCommand
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (png = (dpi1x = embed "./package-data/cyberchef-128x128.png")),
        grain = (png = (dpi1x = embed "./package-data/cyberchef-24x24.png", 
                        dpi2x = embed "./package-data/cyberchef-48x48.png")),
        market = (png = (dpi1x = embed "./package-data/cyberchef-150x150.png")),
        marketBig = (png = (dpi1x = embed "./package-data/cyberchef-300x300.png")),
      ),
      website = "https://github.com/gchq/cyberchef",
      # This should be the app's main website url.

      codeUrl = "https://github.com/zdb999/cyberchef-sandstorm",
      ...
      categories = [science, developerTools],
      ...
      author = (
        ...
        contactEmail = "zach@zacharyballeisen.com",
        # Email address to contact for any issues with this app. This includes end-user support
        # requests as well as app store administrator requests, so it is very important that this be a
        # valid address with someone paying attention to it.

        pgpSignature = embed "./package-data/pgp-signature",
        ...
        upstreamAuthor = "United Kingdom GCHQ",
      ...
      pgpKeyring = embed "./package-data/pgp-personal-keyring",
      ...
      description = (defaultText = embed "./package-data/description.md"),
      # The app's description in Github-flavored Markdown format, to be displayed e.g.
      # in an app store. Note that the Markdown is not permitted to contain HTML nor image tags (but
      # you can include a list of screenshots separately).

      shortDescription = (defaultText = "Data analyzer"),
      ...
      screenshots = [
        ...
        (width = 1253, height = 613, jpeg = embed "./package-data/screenshot.png"),
